...
<ImageFrame
  ...
  width={2054}
  height={1022}
  caption="A composed report: date range, comparison window and grouping are merchant-selected, not hardcoded. From Recharge's public marketing site."
/>
...
<ImageFrame
  ...
  width={1238}
  height={656}
  caption="Benchmarking a store against category percentiles, with drill-down on hover. From Recharge's public marketing site."
/>
